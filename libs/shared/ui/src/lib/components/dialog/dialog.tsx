...
export function Dialog(props: DialogProps) {
    const { trigger, title, children, buttons, open = false, classNameChildren = '' } = props;
    ...
    return (
        <DialogLib.Root defaultOpen={isOpen} onOpenChange={(o) => setIsOpen(o)}>
            ...
            <DialogLib.Portal>
                ...
                <DialogLib.Content
                    className={`p-5 w-full sm:w-[calc(600px-48px)] sm:max-w-[calc(100vw-48px)] bg-dark-500 border-2 border-dark-300 rounded-md min-w-40 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 animate-dialogFadeIn`}>
                    ...
                    <div className={`mb-3 ${classNameChildren}`}>{children}</div>
